...
function PopupGiorno({ data, attivita, clienti, assets, operatori, onClose, onStato, onMod, onChiudi, onRipianifica }) {
...
function Calendario({ man, clienti, assets, operatori, onRipianifica, onNuovaData, onStato, onMod, onChiudi }) {
  const oggi=new Date();
